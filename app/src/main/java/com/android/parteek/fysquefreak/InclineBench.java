...
public class InclineBench extends AppCompatActivity {

    SliderLayout mDemoSlider;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_incline_bench);
        ...
        url_maps.put("",R.drawable.inclinebench1);
        url_maps.put(" ",R.drawable.inclinebench2);
