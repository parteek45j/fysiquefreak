...
public class ParallelDips extends AppCompatActivity {

    SliderLayout mDemoSlider;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_parallel_dips);
        ...
        url_maps.put("",R.drawable.dips2);
        url_maps.put(" ",R.drawable.dips1);
