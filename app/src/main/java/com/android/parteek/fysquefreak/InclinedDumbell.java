...
public class InclinedDumbell extends AppCompatActivity {

    SliderLayout mDemoSlider;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_inclined_dumbell);
        ...
        url_maps.put("",R.drawable.inclinedumb);
        url_maps.put(" ",R.drawable.inclinedumb1);
